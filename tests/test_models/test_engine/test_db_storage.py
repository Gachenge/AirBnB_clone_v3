...
class Testgetcount(unittest.TestCase):
    def test_get(self):
        ...
        self.assertRaises(TypeError, models.storage.get(State, None), None)
        odit = list(models.storage.all(State).values())[0].id
        obj = models.storage.get(State, odit)
        self.assertIs(type(obj), models.state.State)
